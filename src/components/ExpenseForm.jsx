...
export const ExpenseForm = () => { 
    ...
    const totalExpenses = !state.editingId 
        ? state.expenses.reduce((total, expense)=>expense.amount+total, 0) 
        : state.expenses.filter(storedExpense=>storedExpense.id !== expense.id).reduce((total, expense)=>expense.amount+total, 0);
    ...
    const handleSubmit = (e) => { 
        ...
        console.log("Gasto: " + expense.amount);
        console.log("Presupuesto: " + remainingBudget)

        if (expense.amount > remainingBudget) {
            setError('El monto supera el presupuesto');
            return
        }
